          ...
          <div className="space-y-4 col-span-2 lg:col-span-1">
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <a
                  href="https://x.com/onehopeindia"
                  target="_blank"
                  rel="noreferrer"
                  className="w-8.5 h-8.5 rounded-xl bg-[#000000] text-white flex items-center justify-center shadow-md transform hover:scale-110 hover:-translate-y-0.5 transition-all duration-300"
